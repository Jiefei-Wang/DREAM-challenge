...
```{r,warning=FALSE,results='hide',messages=FALSE}
...
#Predict the gene expression for 11th gene
1~10 genes are in the insitu data so that we don't need to predict them
```{r}
k=11
